...
def padding_report_data():
    ...
    GL.actual_report_data[3] = "Random {} + OK".format(REVERSE_KEY[SEND_TEST_CASE_COMMD[0]])
    if TEST_CASE[1] == "TV":
...
if __name__ == "__main__":
    ...
    TEST_CASE = ["GX", "TV", "RandomLeft+OK", "SwitchDetailEPGEvents"]
    TEST_CASE_COMMD = ["21", PREPARATORY_WORK, SEND_TEST_CASE_COMMD, EXIT_TO_SCREEN]
