...
def send_test_case_commd():
    ...
    elif TEST_CASE[2] == "Right":
        send_data = TEST_CASE_COMMD[2][1]
    elif TEST_CASE[2] == "LeftOrRight_Random":
...
def padding_report_data():
    ...
    GL.actual_report_data[3] = "LeftOrRight_Random"     # REVERSE_KEY[SEND_TEST_CASE_COMMD[1]]
    if TEST_CASE[1] == "TV":
...
if __name__ == "__main__":
    ...
    TEST_CASE = ["GX", "TV", "LeftOrRight_Random", "SwitchEPGEvents"]
    TEST_CASE_COMMD = ["09", PREPARATORY_WORK, SEND_TEST_CASE_COMMD, EXIT_TO_SCREEN]
