...
def padding_report_data():
    ...
    GL.actual_report_data[3] = "Day+OrDay-_LeftOrRight_Random"
    if TEST_CASE[1] == "TV":
...
if __name__ == "__main__":
    ...
    SEND_TEST_CASE_COMMD = [KEY["GREEN"], KEY["YELLOW"], KEY["LEFT"], KEY["RIGHT"]]        # Green=Day-, Yellow=Day+
    EXIT_TO_SCREEN = [KEY["EXIT"], KEY["EXIT"], KEY["EXIT"]]

    TEST_CASE = ["GX", "TV", "Day+-_LeftOrRight", "SwitchEPGEvents"]
    TEST_CASE_COMMD = ["17", PREPARATORY_WORK, SEND_TEST_CASE_COMMD, EXIT_TO_SCREEN]
