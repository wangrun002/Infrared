...
def send_test_case_commd():
    ...
    elif TEST_CASE[2] == "Day+_LeftOrRight":
        send_data = TEST_CASE_COMMD[2][1]
    elif TEST_CASE[2] == "Day-_LeftOrRight":
        send_data = TEST_CASE_COMMD[2][0]
    while GL.send_commd_state:
        ...
        L_R_random_commd = [KEY["LEFT"], KEY["RIGHT"]]
        random_send_data = sample(L_R_random_commd, 1)[0]
        ...
        if GL.send_test_case_commd_numb == 0:
            ...
            GL.send_test_case_commd_numb = 10
...
def padding_report_data():
    ...
    GL.actual_report_data[3] = "{}_LeftOrRight_Random".format(REVERSE_KEY[SEND_TEST_CASE_COMMD[1]])
    if TEST_CASE[1] == "TV":
...
if __name__ == "__main__":
    ...
    TEST_CASE = ["GX", "TV", "Day+_LeftOrRight", "SwitchEPGEvents"]
    TEST_CASE_COMMD = ["15", PREPARATORY_WORK, SEND_TEST_CASE_COMMD, EXIT_TO_SCREEN]
