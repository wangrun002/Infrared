...
def send_test_case_commd():
    ...
    if TEST_CASE[2] == "Left+OK" or TEST_CASE[2] == "RandomLeft+OK":
        send_data = TEST_CASE_COMMD[2][0]
    elif TEST_CASE[2] == "Right+OK" or TEST_CASE[2] == "RandomRight+OK":
...
def padding_report_data():
    ...
    GL.actual_report_data[3] = "Random {} + OK".format(REVERSE_KEY[SEND_TEST_CASE_COMMD[1]])
    if TEST_CASE[1] == "TV":
...
if __name__ == "__main__":
    ...
    TEST_CASE = ["GX", "TV", "RandomRight+OK", "SwitchDetailEPGEvents"]
    TEST_CASE_COMMD = ["20", PREPARATORY_WORK, SEND_TEST_CASE_COMMD, EXIT_TO_SCREEN]
